...
export interface IDatabaseDriver<C extends Connection = Connection> {
   ...
   */
  find<T extends AnyEntity<T>, P extends string = never, F extends string = never>(entityName: string, where: FilterQuery<T>, options?: FindOptions<T, P, F>): Promise<EntityData<T>[]>;

  /**
   * Finds single entity (table row, document)
   */
  findOne<T extends AnyEntity<T>, P extends string = never, F extends string = never>(entityName: string, where: FilterQuery<T>, options?: FindOneOptions<T, P, F>): Promise<EntityData<T> | null>;
...
export interface FindOneOptions<T, P extends string = never, F extends string = never> extends Omit<FindOptions<T, P, F>, 'limit' | 'offset' | 'lockMode'> {
  lockMode?: LockMode;
  lockVersion?: number | Date;
}

export interface FindOneOrFailOptions<T, P extends string = never, F extends string = never> extends FindOneOptions<T, P, F> {
